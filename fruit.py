...
class Fruit:
    ...
    def reset(self):
        ...
        start_xy = (
            self.settings.block_size * self.settings.grid_blocks // 2
        ) + self.grid_rect.x
    ...
    def set_random_pos(self):
        ...
        x = random.randrange(
            self.grid_rect.x + self.settings.block_size,
            self.grid_rect.width - self.settings.block_size,
            self.settings.block_size,
        )
        y = random.randrange(
            self.grid_rect.y + self.settings.block_size,
    ...
    def draw_fruit(self):
        ...
        rect = pygame.Rect(
            self.pos[0], self.pos[1], self.settings.block_size, self.settings.block_size
        )
